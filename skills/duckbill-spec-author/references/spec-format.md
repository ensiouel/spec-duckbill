...
- Store each specification as a regular repository-relative `specs/<name>.md` file, where `<name>` is one filename stem.
...
- No plan intent, workflow state, or implementation code was introduced.
